...
CAplot.finish_panel( ax, ylabel="Fraction chosen", xlabel="Boundary distance", legend="off", y_minmax=[0.0,1.000001], y_step=[0.25,2], y_margin=0.0, y_axis_margin=0.0, x_minmax=[0.0,9.0], x_margin=0.95, x_axis_margin=0.55, despine=True, x_ticks=xvalues, x_ticklabels=xticklabels)
